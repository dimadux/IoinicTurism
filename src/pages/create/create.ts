...
export class CreatePage{
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private afAuth:AngularFireAuth, private toast: ToastController, public platform:Platform, private storage:Storage) {
  ...
  public createRoute()
  {
    ...
    (this.storage.get(this.nams).then((val) => {
      console.log("Val",val);
    }));
